      ...
      <motion.section {...fadeIn} transition={{ delay: 0.6 }}>
        ...
        >
          ...
          >
            ...
            <p className="text-secondary">CGPA: 3.85 out of 4.00</p>
          </motion.div>
          <motion.div
            className="bg-white dark:bg-dark/50 p-6 rounded-lg shadow-md"
            variants={fadeInUp}
          ...
          >
            ...
            <p className="text-primary mb-2">
              Dhaka Residential Model College (DRMC) • 2018 - 2020
            </p>
            <p className="text-secondary">Group: Science</p>
            <p className="text-secondary">GPA: 5.00 out of 5.00</p>
          </motion.div>
        </motion.div>
      </motion.section>
    </div>
